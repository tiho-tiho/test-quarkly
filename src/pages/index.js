...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section
			...
			color="--light"
			font="--base"
			background="linear-gradient(0deg,rgba(0,0,0,.2) 0%,rgba(0,0,0,.2) 100%),--color-dark url(https://images.unsplash.com/photo-1605208284806-e51734993517?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30&h=2000) 50% 15%/cover"
		>
			<Box>
				<Text
					as="h1"
			...
			<Stack>
				...
				<StackItem width="25%" lg-width="50%" sm-width="100%">
					<Text margin="0px">
						Делаю короткие метафоричные рассказы и стихостроки.{" "}
						<br />
						Фоном или в дорогу, в мозг или в жизнь
					</Text>
				</StackItem>
				<StackItem width="25%" lg-width="50%" sm-width="100%">
					<Text margin="0px">
		...
		<Section padding="64px 0" sm-padding="40px 0" font="--base" color="--dark">
			...
			<Text
				...
				font="--lead"
			>
				Коротенькие работы под длинный ambient для аудиофилов и небольшие зарисовки для визуалов
			</Text>
			<Stack margin-top="40px">
				<StackItem width="25%" lg-width="50%" sm-width="100%">
					...
					<Text as="p" margin="20px 0 5px 0">
						А еще! Я съела сочник возле музыкальной школы...
					</Text>
				</StackItem>
				<StackItem width="25%" lg-width="50%" sm-width="100%" sm-margin-top="24px">
					...
					<Text as="h3" font="--headline3" margin="5px 0 20px 0">
						Осознанность - наркотик
					</Text>
					<Text as="p" margin="20px 0 5px 0">
						.. хотели бы мы вернуться к раю? К ТОМУ раю? Врядли..
					</Text>
				</StackItem>
				<StackItem width="25%" lg-width="50%" sm-width="100%" sm-margin-top="24px">
					<Override slot="StackItemContent" flex-direction="column" />
					<Box height="0" margin="0 0 20px 0" padding-bottom="100%" background="url(https://images.unsplash.com/photo-1552728089-57bdde30beb3?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30&h=2000) 50% 0/cover no-repeat" />
					<Text color="--grey" margin="0">
						Стихостроки
					</Text>
					<Text as="h3" font="--headline3" margin="5px 0 20px 0">
				...
				<StackItem width="25%" lg-width="50%" sm-width="100%" sm-margin-top="24px">
					<Override slot="StackItemContent" flex-direction="column" />
					<Box height="0" margin="0 0 20px 0" padding-bottom="100%" background="url(https://images.unsplash.com/photo-1529573164479-af78bbb26447?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30&w=2000) 50% 0/cover no-repeat" />
					<Text color="--grey" margin="0">
						SHORT STORY
					</Text>
					<Text as="h3" font="--headline3" margin="5px 0 20px 0">
					...
					<Text as="p" margin="20px 0 5px 0">
						Белое вино в бокале оказалось действительно сухим - просто стружка..
					</Text>
				</StackItem>
			</Stack>
		</Section>
		...
		<Components.Img>
			<Box height="0" margin="0 0 20px 0" padding-bottom="100%" background="url(https://images.unsplash.com/photo-1483519173755-be893fab1f46?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30&w=2000) 50% 0/cover no-repeat" />
		</Components.Img>
